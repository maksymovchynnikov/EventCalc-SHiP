...
Masses of LLPs to be probed at SHiP are in the GeV range, and, therefore, there is no unified description of their hadronic decays: at masses m_LLP <~ 1 GeV, one has to use exclusive description of decays, whereas at larger masses, one may switch to perturbative QCD. In the intermediate masses, there should be matching between these two descriptions (see, e.g., [1801.04847](https://arxiv.org/abs/1801.04847) as an example of such an analysis). In `EventCalc`, this is done in the following way:
